...
int main()
{
    ...
    unsigned char *blk_buf = (unsigned char *)malloc(sizeof(unsigned char) * block_size);
    ...
    write_str_to_file(hash_val, sizeof(hash_val) / sizeof(hash_val[0]), file_path_buf, fp);
